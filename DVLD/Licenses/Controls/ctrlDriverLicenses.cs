...
namespace DVLD.Licenses.Local_Licenses.Controls
{
    public partial class ctrlDriverLicenses : UserControl
    {
        ...
        public void LoadInfo(int DriverID)
        {
            ...
            if(_Driver == null)
            {
                MessageBox.Show("there is not Driver with id = " + _DriverID, "Not Found", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        ...
        public void LoadInfoByPersonID(int PersonID)
        {
            ...
            if (_Driver == null)
            {
                MessageBox.Show("There is not Driver linked with Person with id = " + PersonID, "Not Found", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        ...
        public void Clear()
        {
            ...
            _dtDriverInternationalLicensesHistory.Clone();
